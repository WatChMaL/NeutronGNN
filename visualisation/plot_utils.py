...
def plot_actual_vs_recon(actual_event, recon_event, label, energy, predicted_label="neutron", predicted_energy=500, show_plot=False, save_path=None):
    """
    ...
    Args: actual_event        ... 3-D NumPy array with the event data, shape=(width, height, depth)
          ...
          label               ... Str with the true event label, e.g. "e", "neutron"
