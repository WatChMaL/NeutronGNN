...
def get_loaders(path, indices_file, batch_size, workers):

    dataset = WCH5Dataset_trainval(path, indices_file)
...
def get_loaders_encoded(path, indices_file, batch_size, workers):
